...
struct Home: View {
    ...
    @State private var mainServices = ["Apple", "Orange", "Banana", "Lemon", "Tangerine"]
...
//                    .animation(.linear(duration: 0.1), value: headerHeight)
                }
                    ...
                    ScrollViewReader { scrollViewProxy in
                        ...
                        VStack(spacing: 10){
                            ...
                            VStack{
                                LazyVGrid(columns: Array(repeating: .init(.flexible()), count: 3), alignment: .center) {
                                    ReorderableForEach($mainServices, allowReordering: $allowReordering) { item, isDragged in
                                        ZStack {
                                            Color(.white)
                                                .cornerRadius(15)
                        ...
                        .background {
                            ScrollDetector { offset in
                                ...
                                if (viewPositionY != -minScrollP || viewPositionY != 0) && offset > 0 && offset < 44 {
